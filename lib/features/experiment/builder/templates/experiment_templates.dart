      ...
      "rules": [
        {
          ...
          "action": {"type": "show_warning", "message": "Pulse is high"},
      ...
      "rules": [
        {
          ...
          "action": {
            "type": "show_warning",
            "message": "Pendulum angle is large",
          },
      ...
      "rules": [
        {
          ...
          "action": {"type": "show_warning", "message": "Water is low"},
      ...
      "rules": [
        {
          ...
          "action": {"type": "show_warning", "message": "Temperature is high"},
