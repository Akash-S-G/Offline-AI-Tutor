...
class ExplorationCatalogScreen extends StatelessWidget {
      ...
      body: ListView(
        ...
        children: [
          const Text(
            ...
            style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: IDPColors.textPrimary),
          ),
          const SizedBox(height: 8),
          const Text(
            'Choose an exploration to manipulate variables and observe mathematical behaviors.',
            style: TextStyle(color: IDPColors.textSecondary, fontSize: 16),
          ),
          ...
          _buildCatalogSection('Algebra & Functions', [
            _CatalogItem(
              ...
              description: 'Explore slope (m) and y-intercept (c) in y = mx + c.',
              icon: Icons.show_chart_rounded,
              color: const Color(0xFFD97706),
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (_) => const FunctionLabScreen(
                  initialFormula: 'm*x + c',
                  discoveryPrompt: 'Explore how changing the slope (m) and y-intercept (c) affects the line.',
                )));
              },
            ),
            _CatalogItem(
              title: 'Quadratic Functions',
              description: 'Discover how a, b, and c affect the shape of a parabola.',
              icon: Icons.stacked_line_chart_rounded,
              color: const Color(0xFFD97706),
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (_) => const FunctionLabScreen(
                  initialFormula: 'a*x^2 + b*x + c',
                  discoveryPrompt: 'Discover how changing a, b, and c affects the shape and position of the parabola.',
                )));
              },
            ),
          ]),
            ...
            _CatalogItem(
              ...
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (_) => const GeometryWorkspaceScreen(
                  ...
                  discoveryPrompt: 'Observe how the area changes as you drag the radius.',
                )));
              },
            ),
            _CatalogItem(
              ...
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (_) => const GeometryWorkspaceScreen(
                  ...
                  discoveryPrompt: 'Drag the corners to form a right-angled triangle. What do you notice about the sides?',
                )));
              },
            ),
          ]),
          ...
          _buildCatalogSection('Interactive Challenges', [
            _CatalogItem(
              ...
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (_) => FunctionLabScreen(
                  initialFormula: 'a*x^2 + b*x + c',
            ...
            _CatalogItem(
              ...
              color: const Color(0xFF10B981),
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (_) => GeometryWorkspaceScreen(
            ...
            _CatalogItem(
              ...
              color: const Color(0xFF10B981),
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (_) => StatisticsLabScreen(
  ...
  Widget _buildCatalogSection(String title, List<Widget> items) {
    return Column(
      ...
      children: [
        Text(title, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: IDPColors.textPrimary)),
        const SizedBox(height: 12),
        ...items.map((e) => Padding(padding: const EdgeInsets.only(bottom: 12), child: e)).toList(),
        const SizedBox(height: 12),
      ],
    );
  }
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(description, style: const TextStyle(color: IDPColors.textSecondary, fontSize: 14)),
                  ],
                ),
              ),
